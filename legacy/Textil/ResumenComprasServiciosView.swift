//
//  ResumenComprasServiciosView.swift
//  Textil
//
...
struct ResumenComprasServiciosView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("Resumen Compras Servicios")
    }
    ...
    var listaOrdenesView: some View {
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            ForEach(ordenesFiltradas, id: \.persistentModelID) { orden in
                ...
                NavigationLink(destination: DetalleOrdenServicioView(orden: orden)) {
                ...
                .buttonStyle(.plain) // 🔥 importante para que no se vea azul
            }
        }
    }
    ...
    var ordenesFiltradas: [OrdenCompra] {
        ...
        var lista = ordenes.filter {
            $0.tipoCompra == "servicio" && !$0.cancelada
        }
