//
//  DetalleOrdenServicioView.swift
//  Textil
//
...
struct DetalleOrdenServicioView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("Detalle orden servicio")
    ...
    func dibujarOrden(_ y: CGFloat) -> CGFloat {
        ...
        for detalle in orden.detalles {
            ...
            let linea = """
            Servicio: \(detalle.modelo)
            Cantidad: \(detalle.cantidad) pz
            Costo unitario: \(dinero(detalle.costoUnitario))
            Subtotal: \(dinero(detalle.subtotal))
            """
